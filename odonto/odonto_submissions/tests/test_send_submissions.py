...
class SendSubmissionTestCase(OpalTestCase):
    ...
    def test_success_fp17(self, render_to_string, send_submission, send_email):
    ...
    def test_fail_fp17(self, render_to_string, send_submission, send_email):
    ...
    def test_success_fp17o(self, render_to_string, send_submission, send_email):
    ...
    def test_fail_fp17o(self, render_to_string, send_submission, send_email):
        send_submission.side_effect = ValueError('boom')
        self.episode.category_name = FP17OEpisode.display_name
        self.episode.save()
        self.patient.demographics_set.update(
    ...
    def test_ignores_some_fp17o(self, render_to_string, send_submission, send_email):
        send_submission.side_effect = ValueError('boom')
        self.episode.category_name = FP17OEpisode.display_name
        self.episode.save()
        self.patient.demographics_set.update(
    ...
    def test_threshold_breached(self, render_to_string, send_submission, send_email):
        send_submission.side_effect = ValueError('boom')
        Episode.objects.update(
            category_name=FP17Episode.display_name
        )
    ...
    def test_none(self, render_to_string, send_submission, send_email):
