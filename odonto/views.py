...
class Stats(LoginRequiredMixin, TemplateView):
    ...
    def get_month_totals(self):
        monthly_claims = []
        for date_range in self.month_iterator(self.date_range[0]):
    ...
    def get_uoa_data(self):
        ...
        for date_range in self.month_iterator(self.date_range[0]):
            ...
            by_period.append(month_uoa_total)
    ...
    def get_uda_data(self):
        ...
        for date_range in self.month_iterator(self.date_range[0]):
            ...
            by_period.append(round(month_uda_total))
        return by_period, by_performer
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        ctx.update({
            ...
            "uda_info": {
                "total":  sum(uda_by_period),
                "by_period": json.dumps(uda_by_period)
            },
            "uoa_info": {
                "total":  sum(uoa_by_period),
